...
revue conjointe avec le développeur du module REASONING.

Référence : docs/ACTION_INTEGRATION_HANDOFF.md (section 3), version 1.0.
La forme exacte des champs (noms, types, contraintes) est verrouillée
côté REASONING (testée en CI depuis le Sprint 1) — ne pas l'adapter ici.
